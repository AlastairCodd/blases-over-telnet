abstract class Source
  ...
  def get_most_recent_event_for_games(day : Int32, season : Int32, sim : String) : Array(JSON::Any)?
  ...
  def get_all_games(season : Int32, sim : String, started : Bool = true) : Array(JSON::Any)?
    url = URI.parse(ENV["CHRON_API_URL"])
